      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-white/40">审核通过后按需输出；项目结束后再反哺知识库</p>
          </div>
        </div>
        <div className="flex items-center gap-2 text-xs text-white/40 font-mono">
          <Workflow className="w-3.5 h-3.5 text-emerald-400" />
          <span>app/tools/export.py + app/tools/archive.py</span>
        </div>
      </div>
        ...
        <div className="bg-[#0f3460]/30 rounded-xl p-4 border border-white/5" style={{ borderLeft: '3px solid #8e44ad' }}>
          ...
          <ul className="space-y-1.5 text-[10px] text-white/50 font-mono leading-relaxed">
            <li className="flex items-start gap-2">
              ...
              <span>ArchiveTool → brand_info table UPSERT</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-[#8e44ad]">•</span>
              <span>ArchiveTool → competitor_library / case_labels</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-[#8e44ad]">•</span>
              <span>ArchiveTool → review_records table</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-[#8e44ad]">•</span>
