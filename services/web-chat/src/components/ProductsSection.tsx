...
const products = [
  {
    ...
    color: '#27ae60',
    modules: [
      'skills/s3_industry_insight.py (行业关键词矩阵 KOS 账号分析)',
      'app/agent.py S5 → tool_empowerment 模块',
  ...
  },
  {
    ...
    color: '#f39c12',
    modules: [
      'skills/s7_content_gen.py (10 页 Slide 内容生成，HTML 中间格式)',
  ...
  },
  {
    ...
    color: '#e94560',
    modules: [
      'skills/s7_content_gen.py (案例展示 / 封面生图模块可集成)',
  ...
  },
  {
    ...
    color: '#d35400',
    modules: [
      'skills/s8_format_output.py: _build_slide_xml() Slide 背景图合成',
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-white/40 mt-0.5">6 大产品线 · 映射至 Agent Skill 模块与底层实现</p>
          </div>
        </div>
        <div className="flex items-center gap-2 text-xs text-white/40">
          <Cpu className="w-3.5 h-3.5 text-[#f39c12]" />
          <span>services/orchestrator/app/agent.py · S5.operation_strategy</span>
        </div>
      </div>
