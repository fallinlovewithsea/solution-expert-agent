...
const architectureLayers = [
  ...
  },
  {
    ...
    connections: [
      'S2: MemoryStore.record_search() + record_industry()',
      'S8: record_output_format() (slides / pptx)',
      'S9: save_session() + record_bid_result() + increment_interaction()'
    ]
  },
];
