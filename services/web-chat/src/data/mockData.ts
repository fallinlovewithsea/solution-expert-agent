// 3 个核心 Skill；输出和归档属于工具及生命周期事件
export const stages = [
  {
    id: 'S1',
    name: '需求简报',
    description: '提取客户需求、识别关键信息缺口并选择研究模式',
    status: 'completed' as const,
    inputs: ['客户沟通记录', '招标文件', '研究模式'],
    outputs: ['需求简报', '缺失信息', '研究模式'],
    icon: 'ClipboardList'
  },
  {
    id: 'S2',
    name: '决策洞察',
    description: '整合行业、搜索意图、竞品和客户证据，生成用户决策地图',
  ...
  },
  {
    id: 'S3',
    name: '方案生成',
    description: '一次生成策略、案例、实施路径和标准页面内容',
    status: 'pending' as const,
    inputs: ['需求简报', '用户决策地图', '案例检索结果'],
    outputs: ['统一 ProposalSpec', '10页审核稿'],
    icon: 'FileText'
  }
];
